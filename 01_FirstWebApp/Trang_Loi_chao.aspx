<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trang_Loi_chao.aspx.cs" Inherits="_01_FirstWebApp.Trang_Loi_chao" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txtTen" runat="server" Width="356px"></asp:TextBox>
            <br />
